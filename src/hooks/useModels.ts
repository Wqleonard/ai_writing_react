...
const DEFAULT_QUICK_CHAT_INPUT_CHANNELS: QuickChatInputChannel[] = [
  {
    title: "我想写",
    icon: "&#xe63f;",
    value: [
...
export function useModels() {
  const [quickChatInputChannels] =
    useState<QuickChatInputChannel[]>(DEFAULT_QUICK_CHAT_INPUT_CHANNELS);
  return {
