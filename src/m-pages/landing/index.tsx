...
import GONG_AN from '@/assets/images/gongan.png'
  ...
  return (
    <div className="overflow-y-auto h-screen overflow-x-hidden hide-scrollbar bg-[#f7f7f4]">
      ...
      <div className="flex flex-col items-center pt-20">
        {/* 首屏 */}
        <div className="h-[calc(100dvh-5rem)] flex flex-col w-full">
          {/* 图片区域 */}
          <div className="relative flex-1 w-full min-h-0">
            <div
              className="absolute top-28 left-75 rounded-[30px] overflow-hidden h-[90%] w-200 bg-[#dfdfdf] rotate-[5deg]"/>
            <img
              src={MAIN}
              alt="editor"
        ...
        {/* 排名 */}
        <section className="mt-30 w-full flex flex-col justify-center">
        ...
        <section className="mt-39 text-center">
          ...
          <div className="text-2xl text-[#464646] mt-2">爆文猫不仅是一个写作工具，更是你的码字陪伴者</div>
        </section>
        ...
        <div className="mt-22 flex flex-col gap-2 items-center text-[#999999] text-2xl pb-40">
          ...
          >
            <img src={GONG_AN} alt="" className="w-4 h-4 object-cover mr-2" loading="lazy"/>
