...
import CLAW_CAT from "@/assets/landing_image/claw_cat.png";
...
export function HeroSection({
  ...
  const handleMenuLeave = () => {
    setTimeout(() => {
      isHoveredDropdownRef.current = false;
    }, 200);
    setShowDropdown(false);
  };
    ...
    <div className="relative flex flex-row items-center justify-center w-screen min-h-screen overflow-hidden px-20">
      ...
      <div>
        <img
          src={penIcon}
          alt="pen"
          className="w-29.5 h-27.75 mb-7.5"
          loading="lazy"
        />
        ...
        <p className="text-[1.5rem] text-[#464646] m-0 mb-20 leading-[1.32] font-YaHei">
          ...
          <div ref={dropdownContainerRef} className="relative flex flex-col">
            ...
            >
              ...
              {isButtonHovered && (
                <svg
                  className={cn(
                    "w-4.25 h-1.75 shrink-0 transition-transform duration-300",
        ...
        {/* 龙虾 */}
        <div className="w-[584px] mt-10 flex items-center justify-between flex-nowrap h-25 rounded-[24px] [background:linear-gradient(90deg,#FF6666_0%,#FF2A2A_100%)]">
          <div className="-mt-19.5 -ml-2.5 size-38.5 shrink-0 h-full">
            <img src={CLAW_CAT} alt="爆文猫龙虾版本" className="size-38.5"/>
          </div>
      ...
      <div className="relative w-250 h-152 h-relative flex pl-14 py-15  items-center justify-center">
        <div className="absolute top-0 left-40 w-[70%] h-full bg-[#dfdfdf] rotate-[5deg] rounded-3xl"></div>
        <img
