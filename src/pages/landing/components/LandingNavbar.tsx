    ...
    <nav className="fixed top-0 left-0 right-0 z-9999 bg-[#f7f7f4 py-5 px-[86.92px]">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-row items-center">
          <div className="flex size-7 items-center justify-center overflow-hidden">
            <img src={LOGO} alt="爆文猫写作" className="size-10 max-h-10 max-w-10" />
          </div>
          <span className="ml-2.5 text-lg font-bold text-[#80807d]">爆文猫写作</span>
        ...
        <div className="flex items-center gap-[15px]">
          <a
            ...
            className="flex size-[33px] items-center justify-center transition-opacity duration-300 hover:opacity-70"
          >
